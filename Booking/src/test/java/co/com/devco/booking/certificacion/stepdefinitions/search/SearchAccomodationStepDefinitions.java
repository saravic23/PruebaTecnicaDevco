package co.com.devco.booking.certificacion.stepdefinitions.search;
...
public class SearchAccomodationStepDefinitions extends GeneralStepDefinitions {
    ...
    public void youWillSeeAnAccommodationThatTheFirstOptionIsLessThanOneKmFromTheCityCenter() {
        OnStage.theActorInTheSpotlight().should(seeThat(ValidateAccomodation.was(),
                Matchers.containsString( "a 0,5 km del centro")).orComplainWith(SearchAccommodationException.class, ACCOMMODATION_ERROR
        ));
    }
